...
/**
 * In computer science, quickselect is a selection concept.algorithm to find the k-th smallest element in an unordered list. It is related to the quicksort sorting concept.algorithm.
 * <p>
...
public class QuickSelect {
    // https://www.javatips.net/api/java-algorithms-implementation-master/src/com/jwetherell/algorithms/search/QuickSelect.java
