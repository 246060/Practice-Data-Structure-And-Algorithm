package concept_study.algorithm.Graph.Flow_Network.Ford_Fulkerson;

import java.util.LinkedList;
import java.util.Queue;

public class Minimum_Cut {
    ...
    private static void minCut(int[][] graph, int s, int t) {
        ...
        // graph as residual capacities in residual graph rGraph[i][j] indicates residual capacity of edge i-j
